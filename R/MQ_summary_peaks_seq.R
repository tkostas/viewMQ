#'Number of peaks sequenced (read from MaxQuant summary.txt)
#'
...
#'
#'@export
MQ_summary_peaks_seq <- function(x, grouping = FALSE){
  if (grouping == TRUE) {
  ...
  p <- p + ggtitle("Number of peaks sequenced per experiment.")
